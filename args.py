...
class Args:
    def __init__(self):
        ...
        parser.add_argument('--train_ir', type=str, default='./train_dataset_448/cropped_ir', help='Path to the IR dataset')
        parser.add_argument('--train_vi', type=str, default='./train_dataset_448/cropped_vi', help='Path to the VI dataset')
        ...
        #parser.add_argument('--image_size', type=int, default=448, help='Size of the input images')
